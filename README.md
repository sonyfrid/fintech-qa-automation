...
![Запуск тестов](0001.png)

### Результаты тестирования

![Результаты тестов](0002.png)
...
| Скриншот | Описание |
|----------|----------|
| ![Запуск](0001.png) | Консоль с результатами запуска тестов |
| ![Результаты](0002.png) | Итоговая статистика тестирования |
